...
const Footer = () => {
  return (
    <div className="px-6 md:px-20 pt-12 pb-7 bg-darket-purple ">
      ...
      <div className="flex flex-col md:flex-row gap-14">
        ...
        <div className="w-1/2 md:w-1/6">
          ...
          <div className="mt-3 text-left text-xs font-light text-white space-y-2 capitalize">
            ...
            <div className="flex flex-row gap-3 items-center">
              <FaTiktok className="rounded-full bg-purple-500 size-4 p-0.5" /> <p>TikTok</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* NEWLETTER */}
      <div className="flex flex-row mt-7 text-right gap-4 text-white w-full">
        <div className="hidden md:block md:w-4/6"></div>
      ...
      <div className="mt-10 text-center text-white font-thin text-sm">
        <p>©Copyright. 2024 Web Magnetism All rights reserved I Terms and condition I Privacy Policy.</p>
      </div>
    </div>
  );
};
